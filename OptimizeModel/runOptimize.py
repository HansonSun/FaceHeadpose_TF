...
os.system("python optimize_for_inference.py --input=ConvertedModels/%s --output=ConvertedModels/%s.optimized --frozen_graph=True --input_names='input' --output_names='vgg_a/fc8/squeezed' "%(pbfile,pbfile))
